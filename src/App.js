    ...
    <div className='container'>
      <div className='main'>
       ...
       <div className='footer'>
          ...
          <a href='#' className='footer__link'><img src='img/I4G.png' className='footer__img'/></a>
          <a href='#' className='footer__link footer__img'>HNG internship 9 Frontend Task</a>
         <a href='#' className='footer__link'> <img src='img/zuri-logo.png' className='footer__img'/></a>
          </div>
        </div>
    </div>
  );
